...
function() {
    ...
    function t() {
        var t = {
            ...
            close: function(t, e) {
                this.closeLogOnClick && t.addEventListener("click",
                function() {
                    o(t)
                }),
            ...
            log: function(t, e, o) {
                var n = top.document.querySelectorAll(".alertify-logs > div");
                if (n) {
                    var i = n.length - this.maxLogItems;
                    if (i >= 0) for (var a = 0,
                    l = i + 1; l > a; a++) this.close(n[a], -1)
                }
                this.notify(t, e, o)
            },
            ...
            setupLogContainer: function() {
                var t = top.document.querySelector(".alertify-logs"),
                e = this.logContainerClass;
                return t || (t = top.document.createElement("div"), t.className = e, this.parent.appendChild(t)),
            ...
            setup: function(t) {
                function e(e) {
                    ...
                    l && l.addEventListener("keyup",
                    function(t) {
                        13 === t.which && i.click()
                    })
                }
                var n = top.document.createElement("div");
                ...
                setTimeout(function() {
                    ...
                    l && t.type && "prompt" === t.type ? (l.select(), l.focus()) : i && i.focus()
                },
                100),
                r
            },
            ...
            injectCSS: function() {
                if (!top.document.querySelector("#alertifyCSS")) {
                    var t = top.document.getElementsByTagName("head")[0],
                    e = top.document.createElement("style");
                    e.type = "text/css",
                    e.id = "alertifyCSS",
            ...
            removeCSS: function() {
                var t = top.document.querySelector("#alertifyCSS");
